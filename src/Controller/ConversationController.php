...
class ConversationController extends AbstractController
{
    ...
    /**
     * @Route("/conversations/", name="newConversations", methods={"POST"})
    ...
    public function index(Request $request)
    {
        ...
        // je ne peux avoir une conversation avec moi-même
        if ($otherUser->getId() === $this->getUser()->getId()) {
            throw new \Exception("C'est sympa mais tu ne peux pas créer une conversation avec toi-même");
        }
